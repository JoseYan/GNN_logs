...
def run(rank, world_size, args):
    ...
    g = data.graph.to(dev_id)
    print('my graph:', g)
    print('my feat:', features)
    model = GCN(g, n_nodes, local_n_nodes, True, feat_size, args.n_hidden, n_classes,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--nproc_per_node", default=2,
