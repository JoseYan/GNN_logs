...
class Net(torch.nn.Module):
    ...
    def forward(self, data, use_sparse=True):
...
fileHandler = logging.FileHandler(output_dir+"/"+"{}_gcn_{}_{}_{}.log".format(data_name, 'full', lr, dr))
...
for epoch in range(4000):
    ...
    if tmp_test_acc > best_test_acc:
        ...
        if best_test_acc - tmp_test_acc <= epsilon and best_epoch <= 0.5 * epoch and epoch>100:
            # converged
            break
